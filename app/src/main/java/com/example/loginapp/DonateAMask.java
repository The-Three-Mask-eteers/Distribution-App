...
public class DonateAMask extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        for (Map.Entry<String, Entity> entry: Objects.placesThatAcceptDonations.entrySet()) {
...
// Create an ArrayAdapter using the string array and a default spinner layout
        ArrayAdapter<CharSequence> arrayAdapter = new ArrayAdapter(this, android.R.layout.simple_list_item_1, Objects.placesThatAcceptDonationsNames);
